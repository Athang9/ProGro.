...
from flask import Flask, render_template, jsonify, request, redirect, url_for, make_response, jsonify
import pickle
...
def agrinews():
	try:
		...
		#wa= a1+a2+a3
		#res=requests.get(wa)
		r=requests.get("https://serpapi.com/search.json?q=IndiaAgriculture&location=india&tbm=nws&api_key=b12217562727563e8f023a862765dac7a70f93ee5d16b65cfe45654851c93dcb")
		data=r.json()
		#print(data)
